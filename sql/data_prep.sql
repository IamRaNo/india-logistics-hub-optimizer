...
bills_growth as(
    select
        `state`,
        round((`2019-20` - `2018-19`) / `2018-19` * 100, 2) as `19-20`,
        round((`2020-21` - `2019-20`) / `2019-20` * 100, 2) as `20-21`,
        round((`2021-22` - `2020-21`) / `2020-21` * 100, 2) as `21-22`,
        round((`2022-23` - `2021-22`) / `2021-22` * 100, 2) as `22-23`
    from bills_agg
)
